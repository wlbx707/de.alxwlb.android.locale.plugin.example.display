...
public final class ReceiverTest extends AndroidTestCase
{
    ...
    public void testSatisfiedDisplayOn()
    {
         ...
         */
        final WakeLock wakeLock = ((PowerManager) getContext().getSystemService(Context.POWER_SERVICE)).newWakeLock(PowerManager.FULL_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "test"); //$NON-NLS-1$
        try
        {
            wakeLock.acquire();
