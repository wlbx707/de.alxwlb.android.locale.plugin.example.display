...
public final class PluginBundleManagerTest extends TestCase
{
    ...
    public static void testExtraConstants()
    {
         ...
         */
        assertEquals("de.alxwlb.android.locale.plugin.extra.BOOLEAN_STATE", PluginBundleManager.BUNDLE_EXTRA_BOOLEAN_STATE); //$NON-NLS-1$
        assertEquals("de.alxwlb.android.locale.plugin.extra.INT_VERSION_CODE", PluginBundleManager.BUNDLE_EXTRA_INT_VERSION_CODE); //$NON-NLS-1$
    }
